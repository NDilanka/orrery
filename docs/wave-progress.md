...
| U1+U2 language/legibility + layout grid | pending | — |
| A2 generalization (LoopDriver contract, decide() in BMAD, config loader/schema, dead config, PROTOCOL refresh) | pending | — |
| U3 creation & onboarding (TASK.md scaffold, probe-gate, honest dials, empty state) | pending | — |
