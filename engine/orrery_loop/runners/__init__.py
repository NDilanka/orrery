...
:func:`get_runner` maps a backend name to a concrete :class:`~orrery_loop.runners.base.AgentRunner`
instance. ``"claude"``, ``"aider"`` and ``"codex"`` are wired.
"""

from __future__ import annotations

from orrery_loop.runners.aider import AiderRunner
...
from orrery_loop.runners.codex import CodexRunner
