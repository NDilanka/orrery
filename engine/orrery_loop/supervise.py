...
follows the same injection pattern as :mod:`orrery_loop.heartbeat`.
"""
...
from orrery_loop.events import supervisor_restart_event
from orrery_loop.logio import append_event
from orrery_loop.proc import kill_tree, spawn_tree
...
def supervise(
    ...
    *,
    ...
    ``emit``, default :func:`orrery_loop.logio.append_event`) and a human line to
