...
def metrics_event(
    ...
    :func:`orrery_loop.metrics.compute_metrics`'s output. NEW in engine v3 (no PowerShell
...
def bmad_metrics_event(
    ...
    :func:`orrery_loop.metrics.compute_metrics` shapes don't apply; this carries the BMAD pipeline's own
...
def supervisor_restart_event(
    ...
    """Additive ``supervisor-restart`` event — :mod:`orrery_loop.supervise` relaunched its wrapped
